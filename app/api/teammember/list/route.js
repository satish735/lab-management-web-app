...
export const GET = async (request, { params }) => {
    try {
        ...
        const getAllEntries = await StaffMember
            .find(searchFilter)
            .sort(sort)
            .skip(skip)
            .limit(pageSize);
        ...
        const totalCount = await StaffMember.find(searchFilter).countDocuments();

        var response = { data: getAllEntries, total: totalCount }
