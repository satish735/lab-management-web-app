    ...
    const [packageCategoryResponse, packageCategoryHandler] = useAPI(
        ...
        (e) => {
            toast.error(transformErrorDefault(
                "Something went wrong while Getting package category!",
                e
            ));
            return e
        }
    ...
    return (
        <div>
            ...
            <div className="admin-content-box">
                <h1 className="main-heading">Package Category</h1>
                <p className="sub-heading">Listing page for package category.</p>
                <div className="text-end my-2">
                    <button
                        className=" btn btn-outline-dark"
                        onClick={() => {
                            router.push("/admin/package-category/create");
                        }}
                        type="button"
                    >
                        {" "}
                ...
                <br />
                <CustomTable
                    loading={packageCategoryResponse?.fetching}
                    columns={columns}
                    data={getlistingdata ?? []}
                    sort={sort}
