...
const FrachisingOpportunityPage = ({ searchParams }) => {
    ...
    const [DeletebodypartResponse, DeleteContactDetailsHandler] = useAPI(
        ...
        (e) => {
            router.push("/admin/frachising-opportunity")
        ...
        <>
            <BreadcrumbDiv
                options={[
                    ...
                    { label: "Franchising Opportunity", link: "/admin/franchising-opportunity" },
                    { label: "Franchising Opportunity Details", link: "/admin/franchising-opportunity/view", active: true },
                ]}
            />
                        ...
                        <div className="row">
                            ...
                            <div className="my-3 text-end">
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        router.push("/admin/franchising-opportunity");
                                    }}
                                    type="button"
                                >
                                    {" "}
...
export default FrachisingOpportunityPage;
