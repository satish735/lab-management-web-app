...
export default function Home() {
  ...
  // frachising - opportunities  hospital - management lab_acquistion  corporate - wellness
        ...
        return (
          <>
            <ActionOption
              ...
              name="View"
              onClick={() => {
                router.push(`/admin/franchising-opportunity/view?id=${row?._id}&type=view`);
    ...
    <div>
      <BreadcrumbDiv
        options={[
          ...
          { label: "Franchising Opportunity", link: "/admin/franchising-opportunity", active: true },
        ]}
      />
      <div className="admin-content-box">
        <h1 className="main-heading">Franchising Opportunity Details</h1>
        <p className="sub-heading">Listing page for franchising opportunity details.</p>
