...
const ViewCorporateWelnessPage = ({ searchParams }) => {
        ...
        <>
            <BreadcrumbDiv
                options={[
                    ...
                    { label: "Hospital Lab Management", link: "/admin/hospital-lab-management" },
                    { label: "Hospital Lab Management Details", link: "/admin/hospital-lab-management/view", active: true },
                ]}
            />
                        ...
                        <div className="row">
                            ...
                            <div className="my-3 text-end">
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        router.push("/admin/hospital-lab-management");
                                    }}
                                    type="button"
                                >
                                    {" "}
...
export default ViewCorporateWelnessPage;
