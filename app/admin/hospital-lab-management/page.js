        ...
        return (
          <>
            <ActionOption
              ...
              name="View"
              onClick={() => {
                router.push(`/admin/hospital-lab-management/view?id=${row?._id}&type=view`);
    ...
    <div>
      <BreadcrumbDiv
        options={[
          ...
          { label: "Hospital Lab Management", link: "/admin/hospital-lab-management", active: true },
        ]}
      />
      <div className="admin-content-box">
        <h1 className="main-heading">Hospital Lab Management Details</h1>
        <p className="sub-heading">Listing page for hospital lab management details.</p>
