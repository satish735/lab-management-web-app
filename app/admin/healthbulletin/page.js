        ...
        return (
          <>
            <ActionOption
              ...
              name="View"
              onClick={() => {
                router.push(`/admin/healthbulletin/view?id=${row?._id}&type=view`);
              }}
            />
            <ActionOption
              Icon={Pencil}
              name="Edit"
              onClick={() => {
                router.push(`/admin/healthbulletin/view?id=${row?._id}&type=edit`);
              }}
            />
          </>
        );
    ...
    <div>
      <BreadcrumbDiv
        options={[
          ...
          { label: "Health Bulletin", link: "/admin/healthbulletin", active: true },
        ]}
      />
      <div className="admin-content-box">
        <h1 className="main-heading">Health Bulletin</h1>
        <p className="sub-heading">Listing page for Health Bulletin.</p>
