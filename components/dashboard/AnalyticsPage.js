...
const AnalyticsPage = () => {
    ...
    return (<>
        <div className="admin-content-box">
            ...
            <p className="sub-heading">Visualize your information in beautiful way.</p>
        </div>
        ...
        <div className='w-100 '>
            <span className={`chart-option-tab ${'booking' == selectedTab? "selected" :""}`} onClick={() => { setSelectedTab("booking") }} >Bookings</span>
            <span className={`chart-option-tab ${'transaction' == selectedTab? "selected" :""}`} onClick={() => { setSelectedTab("transaction") }}>Transactions</span>
            <span className={`chart-option-tab ${'patient' == selectedTab? "selected" :""}`} onClick={() => { setSelectedTab("patient") }}>Patients</span>
            <span className={`chart-option-tab ${'collection' == selectedTab? "selected" :""}`} onClick={() => { setSelectedTab("collection") }}>Home Collections</span>
        </div>
